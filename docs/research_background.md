...
[Потоки приложения](application.md), [аудит](application_audit.md),
[состояние моделей](model_validation/pass_02.md),
[упаковка macOS](macos_packaging.md).
...
Состояние файлов и наблюдения записаны в [журнале](experiment_log.md).
...
Документация: [архитектура](simulator_architecture.md),
[физика и следы](vehicle_physics.md), [броня](armour_and_ballistics.md),
[нейронный интерфейс](brain_vehicle_interface.md), [обучение](training.md),
[известные ограничения](known_approximations.md),
[проверка моделей](vehicle_visual_references.md).
