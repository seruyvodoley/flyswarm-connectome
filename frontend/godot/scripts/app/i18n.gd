...
const RU = {
	...
	"AUTONOMOUS BATTLE": "АВТОНОМНЫЙ БОЙ",
	"RESEARCH LABORATORY": "ИССЛЕДОВАТЕЛЬСКАЯ ЛАБОРАТОРИЯ",
	"TRAINING": "ОБУЧЕНИЕ",
	"READOUT TRAINING": "ОБУЧЕНИЕ READOUT-АДАПТЕРА",
	"TEST RANGE": "ПОЛИГОН",
	"REPLAYS": "ПОВТОРЫ",
	"SETTINGS": "НАСТРОЙКИ",
	"Run or observe an 8×8 battle using Rule AI, MaleCNS or a trained adapter.": "Запустите или наблюдайте бой 8×8 с Rule AI, MaleCNS или обученным адаптером.",
	"Run reproducible experiment series across seeds and compare conditions.": "Проводите воспроизводимые серии экспериментов по разным seed и сравнивайте условия.",
	"Fit and evaluate an external motor readout from MaleCNS features. Teacher imitation; no reward.": "Обучайте и проверяйте внешний моторный readout по признакам MaleCNS. Имитация учителя; без награды.",
	"Manually drive and fire to inspect mobility, armour, ballistics and damage.": "Управляйте машиной и стреляйте для проверки подвижности, брони, баллистики и урона.",
	"Open recorded simulations without running MaleCNS again.": "Открывайте записанные симуляции без повторного запуска MaleCNS.",
	"Readout Training": "Обучение readout-адаптера",
	"FIXED MALECNS · RIDGE IMITATION": "ФИКСИРОВАННЫЙ MALECNS · RIDGE-ИМИТАЦИЯ",
	"MaleCNS: FIXED / FROZEN · Method: teacher imitation / ridge readout · Reward: not used. Only the implemented turret-tracking task is shown.": "MaleCNS: ФИКСИРОВАН / ЗАМОРОЖЕН · Метод: имитация учителя / ridge readout · Награда не используется. Показана только реализованная задача слежения башней.",
	"EXIT": "ВЫХОД",
